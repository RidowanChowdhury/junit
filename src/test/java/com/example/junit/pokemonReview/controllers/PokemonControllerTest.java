...
class PokemonControllerTest {
    ...
    @Test
    void pokemonDetail() throws Exception {
        int pokemonId = 1;
    ...
    void createPokemon() throws Exception {
        //        use 1 of them
//        given(pokemonService.createPokemon(ArgumentMatchers.any())).willReturn(pokemonDto);
        given(pokemonService.createPokemon(ArgumentMatchers.any())).willAnswer((invocation -> invocation.getArgument(0)));
//when(pokemonService.createPokemon(ArgumentMatchers.any())).thenReturn(pokemonDto);
